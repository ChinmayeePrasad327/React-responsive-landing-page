        ...
        <section id="pricing" className="py-5">
            <Container>
                ...
                <Paragraph className="mt-4">
                    Flexible, transparent pricing designed for businesses at every stage — from startups experimenting with AI to enterprises scaling across teams.
                </Paragraph>
            </Container>
                    ...
                    {pricingPlans.map((plan, key) => (
                        <div key={key} className="relative group h-full">
                            ...
                            <div className="bg-gradient-to-r from-blue-600 to-violet-600 p-1 rounded-3xl h-full">
                                ...
                                <div className="bg-box-bg border border-box-border rounded-3xl shadow-lg shadow-box-shadow p-6 sm:p-8 lg:p-10 h-full flex flex-col relative">

                                    {plan.bestValue && (
                                        <div
                                            className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-white text-xs 
